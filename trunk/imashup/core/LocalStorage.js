...
dojo.declare("imashup.core.LocalStorage", null, {
    ...
    getObject: function(type,JSONString){
        ...
        //alert(obj.configureItems.toString());
            ...
            for(var i = 0; i < obj.length; i++){
                if(typeof (obj[i]) == "object"){
                    ...
                    if(!(Object.prototype.toString.apply(obj[i]) === '[object Array]')){
                        ...
                        //var value = '[' + obj[i] + ']';
                        //eval("(" + "type_obj[" + i + "]" + "= this.getObject(\"Array\",value"+")");
                    }
                }           
                else{
        ...
        for (var key in obj){
            ...
            if(typeof value == "object"){
                ...
                if(!(Object.prototype.toString.apply(value) === '[object Array]')){
                    ...
                    //value = '[' + value + ']';
                    //alert(value);
                    //eval("(" + "type_obj." + key + "= this.getObject(\"Array\",value"+")");
                }
            }
            else{
        ...
        for (var key in object) {
            ...
            if (typeof value == "object") {
                ...
                if(!(Object.prototype.toString.apply(value) === '[object Array]')){
                    ...
                    arrayString = arrayString + this.getJSONString1(value);
                    parts.push(arrayString); 
                }
            }
            else 
